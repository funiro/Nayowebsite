...
<head>
    ...
    <title>Board Members | Nancholi Youth Organization (NAYO)</title>
    
    <!-- Primary Meta Tags -->
    <meta name="title" content="Board Members | Nancholi Youth Organization (NAYO)">
    <meta name="description" content="Meet NAYO's Board of Directors who provide strategic guidance and oversight to our organization.">
    <meta name="keywords" content="NAYO board, Nancholi Youth Organisation leadership, NGO board Malawi, NAYO directors, Malawi NGO governance">
    <meta name="author" content="Nancholi Youth Organization">
    <meta name="robots" content="index, follow">
    
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://nayomalawi.org/board.html">
    <meta property="og:title" content="Board Members | Nancholi Youth Organization (NAYO)">
    <meta property="og:description" content="Meet NAYO's Board of Directors who provide strategic guidance and oversight to our organization.">
    <meta property="og:image" content="https://nayomalawi.org/images/logo.png">
    
    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://nayomalawi.org/board.html">
    <meta property="twitter:title" content="Board Members | Nancholi Youth Organization (NAYO)">
    <meta property="twitter:description" content="Meet NAYO's Board of Directors who provide strategic guidance and oversight to our organization.">
...
<body>
    ...
    <main>
        <section class="page-header">
            ...
            <p>Meet our distinguished board members who provide strategic guidance and oversight.</p>
        </section>

        <section class="staff-section">
            <div class="staff-container">
                <div class="staff-grid">
                    <!-- Board member cards will go here -->
                    <!-- Use the same card structure as staff, but with board member information -->
                </div>
            </div>
        </section>
    </main>
